    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            dao.buscaTodos().map { produtos ->
                ...
                recyclerview.adapter = ConcatAdapter(it)
            }
        }
    }

    private fun criaAdapterDeProdutosComCabecalho(produtosUsuario: Map.Entry<String?, List<Produto>>): List<RecyclerView.Adapter<out RecyclerView.ViewHolder>> {
        return listOf(
